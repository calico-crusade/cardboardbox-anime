...
CREATE UNIQUE INDEX series_uiq ON series (title);
...
CREATE TABLE books (
    ...
    CONSTRAINT fk_books_series_id FOREIGN KEY(series_id) REFERENCES series(id)
);

CREATE UNIQUE INDEX books_uiq ON books (title);
